	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    public Object sendRequest(String path,HttpServletRequest request) throws ServiceException {
		       Object object=null;
		        ...
		        case "/FrontController/updateGrade.do": 
	        	{
	        			GradesController gradesController = new GradesController();
	        			String grade=request.getParameter("grade");
	        			int minmark=Integer.parseInt(request.getParameter("minimummark"));	
	        			int maxmark=Integer.parseInt(request.getParameter("maximummark"));	
	        			object = gradesController.updateGradeRange(grade,minmark,maxmark);
	        			break;
	        	}
		        ...
		        case "/FrontController/checkSubject.do": 
	        	{
	        			...
	        			String subid=request.getParameter("subjectdetails");
	        			int subjectid;		
	        				subjectid=Integer.parseInt(subid);
	        				object = subjectsController.getBySubjectCode(subjectid);
	        			break;
	        	}
		        ...
		        case "/FrontController/checkDepartment.do": 
	        	{
		        	...
		        	case "/FrontController/getGrade.do": 
		        	{
		        		GradesController gradesController = new GradesController();
		        		int grade=Integer.parseInt(request.getParameter("average"));
		        		object =gradesController.getGrade(grade);
		        		break;
		        	}
		    ...
		    private void sendResponse(HttpServletResponse response, Object result) throws IOException {
		        ...
		        if ( result != null) {
		            if ( result instanceof List) {
		               Logger.info("Convert to List JSON");
		                json = gson.toJson(result);
		            }
		            else if ( result instanceof Boolean) {
		               Logger.info("Convert Boolean JSON");
		                JsonObject jsonObject = new JsonObject();
		                jsonObject.addProperty("result", (Boolean) result);
		                json = jsonObject.toString();
		            }
		            else if ( result instanceof Object) {
		               Logger.info("Convert to Object JSON");
		                json = gson.toJson(result);
		            }            
